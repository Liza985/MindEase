						...
						<Link to ="/">
							<div className="flex items-center space-x-2 mt-3">
								...
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="50" height="50">
									{/* Background circle */}
									<circle cx="100" cy="100" r="80" fill="#ffffff" stroke="#FFA500" strokeWidth="2" />
								...
								{/* Text */}
								<div>
									<span className="text-2xl font-bold text-orange-500">Mind</span>
									<span className="text-2xl font-normal text-sky-400">Ease</span>
								</div>
							</div>   
						</Link>   
						{/* Desktop menu */}
