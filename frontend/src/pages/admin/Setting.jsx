...
const Settings = () => {
  ...
  const [settings, setSettings] = useState({
    // General settings
    siteName: "Community Assistance Portal",
    tagline: "Connecting people with resources they need",
    siteDescription: "A platform that connects individuals in need with volunteers and resources to assist them.",
    ...
    // Privacy settings
    privacyPolicyUpdated: "2025-01-15",
  ...
  // Handle cancel
  const handleCancel = () => {
    // In a real app, you would reset to last saved settings
      ...
      <div className="ml-64 flex-grow p-6">
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="flex border-b border-gray-200">
            <button
              className={`px-6 py-3 text-sm font-medium ${activeTab === 'general' ? 'text-orange-600 border-b-2 border-orange-600' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <button
              className={`px-6 py-3 text-sm font-medium ${activeTab === 'users' ? 'text-orange-600 border-b-2 border-orange-600' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <button
              className={`px-6 py-3 text-sm font-medium ${activeTab === 'notifications' ? 'text-orange-600 border-b-2 border-orange-600' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <button
              className={`px-6 py-3 text-sm font-medium ${activeTab === 'privacy' ? 'text-orange-600 border-b-2 border-orange-600' : 'text-gray-500 hover:text-gray-700'}`}
            ...
            <button
              className={`px-6 py-3 text-sm font-medium ${activeTab === 'email' ? 'text-orange-600 border-b-2 border-orange-600' : 'text-gray-500 hover:text-gray-700'}`}
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-gray-500">
                        These settings control how your site appears to users and how basic functionality works.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                        />
                        <label htmlFor="allowGuestMessages" className="ml-2 block text-sm text-gray-700">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center">
                      <Info size={16} className="text-blue-500 mr-2" />
                      <p className="text-sm text-gray-500">
                        These settings determine how user accounts function on your platform.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                        />
                        <label htmlFor="newMessageNotifications" className="ml-2 block text-sm text-gray-700">
              ...
              {activeTab === 'privacy' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      <div>
                        <label htmlFor="privacyPolicyUpdated" className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                        />
                        <label htmlFor="allowDataDownload" className="ml-2 block text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                        />
                        <label htmlFor="anonymizeInactiveUsers" className="ml-2 block text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                        />
                        <label htmlFor="showUserOnlineStatus" className="ml-2 block text-sm text-gray-700">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-gray-500">
                        These settings help ensure compliance with privacy regulations like GDPR and CCPA.
                      </p>
                    </div>
                  </div>
                </div>
