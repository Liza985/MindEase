  ...
  <>
    ...
    <div className="min-h-screen flex flex-col bg-orange-50 pt-20">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 flex flex-col items-center justify-center">
        <h2 className="text-2xl font-semibold text-gray-800">How would you like to connect?</h2>
        <p className="text-gray-600 mb-8">Choose the type of counseling session that works best for you.</p>
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          <div className="bg-white rounded-lg p-8 w-72 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
            ...
            <h2 className="text-xl font-bold text-orange-500 mb-2">AI Counseling</h2>
            <p className="text-gray-600 mb-6">Connect with our AI assistant for immediate guidance and resources. Available 24/7 for your convenience.</p>
          ...
          <div className="bg-white rounded-lg p-8 w-72 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
            <div className="text-5xl mb-4">👤</div>
            <h2 className="text-xl font-bold text-orange-300 mb-2">Human Counselor</h2>
            <p className="text-gray-600 mb-6">Connect with a certified counselor for personalized support and professional guidance.</p>
