...
const BlogDetails = () => {
	...
	const { message, error, blogById, loading } = useSelector(
		(state) => state.blog,
	);
								...
								{blogData
									...
									.map((relatedBlog) => (
										...
										>
											...
											<button
												onClick={() =>
													navigate(`/volunteer/article/${relatedBlog?.id}`)
												}
			...
			{showDeleteModal && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white rounded-lg p-6 max-w-md w-full">
						...
						<p className="text-gray-600 mb-6">
							Are you sure you want to delete "{blogById?.title}"? This action
							cannot be undone.
						</p>
