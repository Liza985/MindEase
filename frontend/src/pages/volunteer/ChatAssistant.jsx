...
const ChatbotAssistant = () => {
	return (
		<div className="flex flex-col min-h-screen bg-gray-50 font-sans">
			...
			{/* Welcome banner with styling that matches header */}
			...
			<main className="flex-grow flex justify-center items-center p-4 md:p-8">
				<div className="w-full max-w-4xl h-96 md:h-[600px] bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
