...
const getContentByCategoryRequest = createAction("GET_CONTENT_BY_CATEGORY_REQUEST");
const getContentByCategorySuccess = createAction("GET_CONTENT_BY_CATEGORY_SUCCESS");
const getContentByCategoryFailure = createAction("GET_CONTENT_BY_CATEGORY_FAILURE");
