...
const getBlogsByVolunteerRequest=createAction("GET_BLOGS_BY_VOLUNTEER_REQUEST");
const getBlogsByVolunteerSuccess=createAction("GET_BLOGS_BY_VOLUNTEER_SUCCESS");
const getBlogsByVolunteerFailure=createAction("GET_BLOGS_BY_VOLUNTEER_FAILURE");
