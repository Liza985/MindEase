...
const getAllUserFeedbacksRequest = createAction(
	"GET_ALL_USER_FEEDBACKS_REQUEST",
);
const getAllUserFeedbacksSuccess = createAction(
	"GET_ALL_USER_FEEDBACKS_SUCCESS",
);
const getAllUserFeedbacksFailure = createAction(
	"GET_ALL_USER_FEEDBACKS_FAILURE",
);
