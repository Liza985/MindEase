...
const surveyCreateRequest = createAction("SURVEY_CREATE_REQUEST");
const surveyCreateSuccess = createAction("SURVEY_CREATE_SUCCESS");
const surveyCreateFailure = createAction("SURVEY_CREATE_FAILURE");
